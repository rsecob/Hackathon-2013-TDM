...
package feathers.controls.renderers
{
	...
	public class DefaultGroupedListHeaderOrFooterRenderer extends FeathersControl implements IGroupedListHeaderOrFooterRenderer
	{
		...
		public function DefaultGroupedListHeaderOrFooterRenderer()
		{
			...
			layout.gap = MetalWorksMobileTheme.DPI_SCALE * 10;
			
			contentContainer.layout = layout;
			contentContainer.verticalScrollPolicy = Scroller.SCROLL_POLICY_OFF;
			contentContainer.horizontalScrollPolicy = Scroller.SCROLL_POLICY_OFF;
		}
		...
		protected function itemToContent(item:Object):DisplayObject
		{
			...
			if(this._contentSourceFunction != null)
			{
				...
				contentContainer.addChild(this.contentImage);
...
//				return this.contentImage;
			...
			else if(this._contentLabelFunction != null)
			{
				...
				contentContainer.addChild(DisplayObject(this.contentLabel));
...
//				return DisplayObject(this.contentLabel);
			...
			{
				contentContainer.addChild(this._contentFunction(item));
//				return this._contentFunction(item) as DisplayObject;
			...
			{
				contentContainer.addChild(item[this._contentField]);
